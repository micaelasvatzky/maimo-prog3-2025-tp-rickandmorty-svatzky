    ...
    >
      ...
      <section className="mb-5">
        <div className="flex flex-col justify-center items-center">
          <h2 className="text-4xl text-amber-100 font-semibold mt-5">Characters</h2>
          {characters.length > 0 ? (
            <CharacterGrid characters={characters} />
          ) : (
            <p className="text-white text-2xl mt-4 col-span-full">No results</p>
          )}
        </div>
      </section>
      ...
      <section className="mb-5">
        <div className="flex flex-col justify-center items-center">
          <h2 className="text-4xl text-amber-100 font-semibold mt-5">Locations</h2>
          {locations.length > 0 ? (
      ...
      <section className="mb-5">
        <div className="flex flex-col justify-center items-center">
          <h2 className="text-4xl text-amber-100 font-semibold mt-5">Episodes</h2>
          {episodes.length > 0 ? (
